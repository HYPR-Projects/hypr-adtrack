-- Create function to prevent duplicate page_views within 5 second window
...
-- Create trigger to prevent duplicate page_views
DROP TRIGGER IF EXISTS trg_prevent_duplicate_page_views ON events;
CREATE TRIGGER trg_prevent_duplicate_page_views
  BEFORE INSERT ON events
  FOR EACH ROW
  EXECUTE FUNCTION public.prevent_duplicate_page_views();